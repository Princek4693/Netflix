...
function VideoBackground({moviesId}){
    ...
    return (
        <div className="w-screen">
            ...
            src={"https://www.youtube.com/embed/" + trailerVideos?.key } title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin"></iframe>
